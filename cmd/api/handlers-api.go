...
import (
	...
	"go-stripe-payment/internal/encryption"
...
func (app *application) SendPasswordResetMail(w http.ResponseWriter, r *http.Request) {
	var payload struct {
		Email string `json:"email"`
	}
...
func (app *application) AllSubscriptions(w http.ResponseWriter, r *http.Request) {
	...
	allSales, lastpage, totalRecords, err := app.DB.GetAllSubsrciptionsPaginated(payload.PageSize, payload.CurrentPage)
	if err != nil {
		app.badRequest(w, r, err)
		return
	}
...
func (app *application) RefundCharge(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		app.badRequest(w, r, errors.New("chrage was refunded, but the database could not be updated"))
		return
	}
